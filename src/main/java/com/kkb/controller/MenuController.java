...
public class MenuController {
    ...
    public AjaxResultVo queryByPage(Integer pageNum, Integer pageSize, MenuQueryVo menuQueryVo){
        PageInfo menuPageInfo = menuService.queryByPage(pageNum, pageSize, menuQueryVo);
    ...
    public AjaxResultVo queryById(@PathVariable("mId") Integer mId){
    ...
    public AjaxResultVo addMenu(Menu menu){
    ...
    public AjaxResultVo deleteById(@PathVariable("mId") Integer mId){
    ...
    public AjaxResultVo updateById(@PathVariable("mId") Integer mId, Menu menu){
    ...
    public AjaxResultVo queryByMName(@PathVariable("mName") String mName){
        List menus = menuService.queryByMName(mName);
        if(menus.size() > 0){
